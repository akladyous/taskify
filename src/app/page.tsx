...
export default function Home() {
  return (
    <div className='h-[2048px] border m-2'>
      <p className='item'>sit ipsum exercitationem?</p>
      <p className='item'>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
